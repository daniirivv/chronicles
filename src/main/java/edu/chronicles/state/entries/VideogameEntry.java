...
import edu.chronicles.state.enums.VideogameAward;
import edu.chronicles.state.enums.VideogameGenderType;
import edu.chronicles.state.enums.VideogamePlatform;
